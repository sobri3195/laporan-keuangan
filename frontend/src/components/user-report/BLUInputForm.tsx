...
const fields: Array<{ key: keyof FinancialValues; label: string; helper: string; placeholder: string }> = [
  { key: 'saldoAwal', label: 'Saldo Awal', helper: 'Masukkan saldo awal sebelum periode berjalan', placeholder: 'Contoh: 50000000' },
...
export function BLUInputForm({ values, errors, disabled, highlighted, onChange }: {
  ...
  return (
    <section className="space-y-3 rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
      <h3 className="font-semibold text-slate-900">Isi Data Keuangan BLU</h3>
